...
const SinglePost = () => {
    ...
    const [myreview, mySetReview] = useState([])
    ...
    return (
        <section className="bg-white container mx-auto dark:bg-gray-900">
            <div className="container px-6 py-10 mx-auto">
                <div className="lg:flex text-left lg:-mx-6">
                    <div className="lg:w-3/4 text-left lg:px-6">
                        <img className="object-cover object-center w-full h-80 xl:h-[28rem] rounded-xl" src={img} alt="" />

                        <div className='text-left'>
                            <p className="mt-6 text-4xl text-blue-500 uppercase">{category}</p>

                            <h1 className="text-4xl mt-6 text-left font-semibold leading-tight text-gray-800 dark:text-white">
                                {name}
                            </h1>

                            <p className="mt-6 text-lg text-blue-500 uppercase"> {ratings} star Rating </p>
                            <p className="mt-6 text-lg text-blue-500 uppercase"> Total {ratingsCount} Count </p>
                            <h1 className="text-3xl mt-6 text-left font-bold leading-tight text-blue-600  dark:text-white">
                                Price: ${price}
                            </h1>
                        </div>
                        <div >
                            <p className="mt-6 text-left text-1xl text-black font-medium uppercase">{description}</p>
                        </div>
                    ...
                    reviews.map(review => {
                        return (
                            <div className="p-8 border rounded-lg dark:border-gray-700">
                                ...
                                <div className="flex justify-center align-middle items-center mt-8 -mx-2">
            ...
            <div className='container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8'>
                {
                    user?.email ? <div className="flex mt-10 text-center dark:bg-gray-900 dark:text-gray-100">
                        <form onSubmit={handleReview} action="" className="flex flex-col w-full max-w-lg p-12 rounded shadow-lg dark:text-gray-100 ng-untouched ng-pristine ng-valid">
